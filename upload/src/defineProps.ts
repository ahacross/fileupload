...
function __VLS_template() {
  ...
  /* Style Scoped */
  type __VLS_StyleScopedClasses = {} & { logo?: boolean } & {
    'router-link-exact-active'?: boolean
  } & { 'router-link-exact-active'?: boolean } & { logo?: boolean } & { wrapper?: boolean }
  ...
  ;[RouterView]
  {
    ...
    }
    {
      ...
      {
        const __VLS_15 = (
          {} as 'HelloWorld' extends keyof typeof __VLS_ctx
            ? { HelloWorld: typeof __VLS_ctx.HelloWorld }
            : typeof __VLS_resolvedLocalAndGlobalComponents
        ).HelloWorld
        const __VLS_16 = __VLS_asFunctionalComponent(
          __VLS_15,
          new __VLS_15({ ...{}, msg: 'You did it!' })
        )
      ...
      }
      {
        ...
        {
          const __VLS_25 = (
            {} as 'RouterLink' extends keyof typeof __VLS_ctx
              ? { RouterLink: typeof __VLS_ctx.RouterLink }
              : typeof __VLS_resolvedLocalAndGlobalComponents
          ).RouterLink
  ...
  {
    const __VLS_35 = (
      {} as 'RouterView' extends keyof typeof __VLS_ctx
        ? { RouterView: typeof __VLS_ctx.RouterView }
        : typeof __VLS_resolvedLocalAndGlobalComponents
    ).RouterView
